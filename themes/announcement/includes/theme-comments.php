	    	...
	    	<a name="comment-<?php comment_ID() ?>"></a>
	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment-container">           
		      	...
		      	<div class="comment-head">
	                <?php if( isset( $woo_options['woo_comments_hideavatar'] ) && get_comment_type() == 'comment' && $woo_options['woo_comments_hideavatar'] == 'false' ) { ?>
	                <div class="avatar"><?php the_commenter_avatar($args) ?></div>
	            	<?php } ?>          
	                <div class="name"><?php the_commenter_link() ?></div>  
	                <span class="date"><?php _e( 'on ', 'woothemes' ); ?><?php echo get_comment_date(get_option( 'date_format' )) ?></span>
