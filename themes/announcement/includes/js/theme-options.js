...
/*-----------------------------------------------------------------------------------*/
	...
	jQuery( '#woothemes-settings #wf-tab-general .woo_metaboxes_table' ).before( '<ul id="woothemes-settings-tabs"></ul>' );
	
	// Add ID to main meta box table, to avoid selector conflicts below.
	jQuery( '#woothemes-settings #wf-tab-general .woo_metaboxes_table' ).attr( 'id', 'woo_metaboxes_table_main' );
	...
	jQuery( '#woothemes-settings label[for$="_heading"]' ).each( function () {
		...
		jQuery( '#woothemes-settings #wf-tab-general #woo_metaboxes_table_main' ).before( '<div id="' + sectionId + '"><table class="woo_metaboxes_table"><tbody></tbody></table></div>' );
		
		jQuery( '#woothemes-settings #wf-tab-general #woothemes-settings-tabs' ).append( '<li><a href="#' + sectionId + '">' + jQuery( this ).text() + '</a></li>' );
	...
	jQuery( '#woothemes-settings-tabs' ).parents( '#wf-tab-general' ).tabs();
