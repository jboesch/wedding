...
class Woo_Widget_Component extends WP_Widget {
	...
	function Woo_Widget_Component () {
		...
		$this->woo_widget_componentslist = array(
												'babystats' => __( 'Baby Statistics', 'woothemes' ), 
												'blog' => __( 'Blog', 'woothemes' ), 
												'comments' => __( 'Comments', 'woothemes' ), 
												'countdown' => __( 'Countdown', 'woothemes' ), 
												'footerwidgets' => __( 'Footer Widgets', 'woothemes' ), 
												'headline' => __( 'Headline', 'woothemes' ), 
												'links' => __( 'Registry/Links', 'woothemes' ), 
												'occassiondetails' => __( 'Occasion Details', 'woothemes' ),
                                                'rsvp' => __( 'RSVP', 'woothemes' ),
                                                'occassionhosts' => __( 'Occasion Hosts', 'woothemes' ),
												'pagecontent' => __( 'Page Content', 'woothemes' ),
												'photoslider' => __( 'Photograph Slider', 'woothemes' ), 
												'embed' => __( 'Video Embed', 'woothemes' ), 
												'subscribe' => __( 'Subscribe &amp; Connect', 'woothemes' )
												);
	...
	function widget( $args, $instance ) {  
		...
		if ( $component != '' ) { locate_template( 'component-' . $component . '.php', true ); }
